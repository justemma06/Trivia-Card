animeQuestions = [
    new Question(
        ...
        [{
                text: 'McDonalds',
                picture: 'mcdonalds-crest.png'
            },
            {
                text: 'Subway',
                picture: 'subway-crest.png'
            },
            {
                text: 'KFC',
                picture: 'kfc-crest.png'
            },
            {
                text: 'Pizza Hut',
                picture: 'pizzahut-crest.png'
            }
        ],
        'Pizza Hut'
    ),
    ...
    new Question(
        ...
        [{
                text: 'Ryuk',
                picture: 'ryuk-crest.jpg'
            },
            {
                text: 'Rem',
                picture: 'rem-crest.jpg'
            },
            {
                text: 'Sidoh',
                picture: 'sidoh-crest.png'
            },
            {
                text: 'Gelus',
                picture: 'gelus-crest.jpg'
            }
        ],
        'Ryuk'
    ),
